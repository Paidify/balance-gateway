...
// western bank api
export const WESTERN_BANK_API_ENDPOINT = process.env.WESTERN_BANK_API_ENDPOINT || 'http://localhost:4000';
export const EAST_BANK_API_ENDPOINT = process.env.EAST_BANK_API_ENDPOINT || 'http://localhost:4000';
